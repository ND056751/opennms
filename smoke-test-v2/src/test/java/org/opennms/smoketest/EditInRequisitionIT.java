...
public class EditInRequisitionIT extends OpenNMSSeleniumIT {
    ...
    public void testIfNotRequisition() throws Exception {
        ...
        final List<WebElement> webElement = driver.findElements(By.linkText("Edit in Requisition"));
    ...
    public void testIfDeployed() throws Exception {
        ...
        final WebElement webElement = driver.findElement(By.linkText("Edit in Requisition"));
        Assert.assertNotNull("Link 'Edit in Requisition' not found in page!", webElement);
        webElement.click();

        Assert.assertEquals("Node my-node-1 at " + OpenNMSSeleniumIT.REQUISITION_NAME,
                driver.findElement(By.cssSelector("#content > div.ng-scope > div > form > div:nth-child(1) > div:nth-child(1) > h4")).getText());
    }
