...
public class BSMAdminIT extends OpenNMSSeleniumIT {
    ...
    public static class BsmAdminPageEditWindow {
        ...
        private BsmAdminPageEditWindow(OpenNMSSeleniumIT testCase) {
            this(testCase, null);
        }

        private BsmAdminPageEditWindow(final OpenNMSSeleniumIT testCase, final String businessServiceName) {
    ...
    public static class BsmAdminPage {
        ...
        public BsmAdminPage(final OpenNMSSeleniumIT testCase) {
            this.testCase = Objects.requireNonNull(testCase);
    ...
    public static class BsmAdminPageEdgeEditWindow {
        ...
        private BsmAdminPageEdgeEditWindow(final OpenNMSSeleniumIT testCase) {
            this.testCase = Objects.requireNonNull(testCase);
        }
    ...
    public static class BsmAdminPageAttributeEditWindow {
        ...
        private BsmAdminPageAttributeEditWindow(final OpenNMSSeleniumIT testCase) {
            this.testCase = Objects.requireNonNull(testCase);
        }
    ...
    private static WebElement findDeleteButton(OpenNMSSeleniumIT testCase, String serviceName) {
     ...
     * @param by
     */
    private static void verifyElementNotPresent(OpenNMSSeleniumIT testCase, final By by) {
