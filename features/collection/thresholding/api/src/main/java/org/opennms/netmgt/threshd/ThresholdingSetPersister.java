...
/**
 * Persister/Retriever for {@link ThresholdingSet}s.
 * Defaults to in memory HashMap implementation.
 * Distributed environments will want to use Casandra based persister.
 *
 */
