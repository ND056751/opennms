...
public class ThresholdingSetTest {
    ...
    public void testBadThresholdingConfigInitialize() throws Exception {
        ...
        new ThresholdingSetImpl(1, "127.0.0.1", "SNMP", new RrdRepository(), null, null);
    }
    ...
    public void testBadThresholdingConfigReinitialize() throws Exception {
        ...
        PollOutagesConfigFactory.init();
        final ThresholdingSetImpl set = new ThresholdingSetImpl(1, "127.0.0.1", "SNMP", new RrdRepository(), null, null);
